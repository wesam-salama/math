...
enum LinearStrokeCap2 { butt, round, roundAll }

// ignore: must_be_immutable
class LinearPercentIndicator2 extends StatefulWidget {
  ...
  final LinearStrokeCap2 linearStrokeCap;

  ///alignment of the Row (leading-widget-center-trailing)
  final MainAxisAlignment alignment;

  ///padding to the LinearPercentIndicator2
  ...
  @override
  _LinearPercentIndicator2State createState() => _LinearPercentIndicator2State();
}

class _LinearPercentIndicator2State extends State<LinearPercentIndicator2>
  ...
  @override
  void didUpdateWidget(LinearPercentIndicator2 oldWidget) {
...
class LinearPainter extends CustomPainter {
  ...
  LinearPainter({
    ...
    this.linearStrokeCap = LinearStrokeCap2.butt,
    this.linearGradient,
    this.maskFilter,
    ...
    if (linearStrokeCap == LinearStrokeCap2.round) {
      _paintLine.strokeCap = StrokeCap.round;
    } else if (linearStrokeCap == LinearStrokeCap2.butt) {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final end = Offset(size.width+5, size.height / 2);
    ...
    if (isRTL) {
      final xProgress = size.width-4 - size.width * progress;
